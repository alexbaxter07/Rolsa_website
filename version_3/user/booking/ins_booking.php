...
// page so that the user can book consults for solar pannels
    ...
    echo "<html lang='en'>";
        ...
        echo "<head>";
            ...
            echo "<title>Installation Booking</title>";
            ...
            echo "<div id='container'>";
                ...
                echo "<div id='content'>";
                    ...
                    echo "<div id='page_title'>";
                        ...
                        echo "<h2>Booking Installation</h2>";

                    echo "</div>";

                    //installaition form which will send results to a separate page
                    echo "<form id='instal' method='post' action='book_val.php'>";

                        // table to organise form contents
                        echo "<table>";

                            //form title
                            echo "<legend><h2>Installation Booking</h2></legend>";

    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <form id="consul" method="post" action="book_val.php"> <!-- user login form which will send results to separate page for validation -->

                    <table>

                        <fieldset>

                            <legend><h2>Consultation Booking</h2></legend>

                            <tr><td><input type="hidden" name="staff" value="con"</td></tr>
